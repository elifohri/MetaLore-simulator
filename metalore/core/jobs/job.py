...
class Job:
    ...
    def job_type(self) -> int:
        """Job type generated by the entity ('UE' for Communication or 'SENSOR' for Sensing)"""
    ...
    def __repr__(self) -> str:
        return (
            f"Job(id={self._id}, Job type={self._job_type}, entity={self._entity_type}:{self._entity_id}, "
