...
from mobile_env.core.constants import SENSOR, USER_DEVICE, UE_JOB, SENSOR_JOB, COMM_LAMBDA, COMP_LAMBDA, PROBABILITY, INITIAL_REQUEST_SIZE, COMPUTATION_REQUEST
